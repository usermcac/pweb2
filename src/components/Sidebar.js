...
import { Layers,Camera } from "react-feather";
...
const BrandIcon = styled(Camera)`
  margin-right: ${props => props.theme.spacing(2)}px;
  color: ${props => props.theme.sidebar.header.brand.color};
`;
const AESIcon = styled(Layers)`
  margin-right: ${props => props.theme.spacing(2)}px;
  color: ${props => props.theme.sidebar.header.brand.color};
`;
  ...
  return (
    <Drawer variant="permanent" {...rest}>
      ...
      {/* CODITY ICON */}
        {/* <BrandIcon /> */}
        <img         
        src={"https://firebasestorage.googleapis.com/v0/b/aes-app-755d2.appspot.com/o/icons%2Ficon_aes_30x30.svg?alt=media&token=310f4eef-e564-445b-8aa1-c8bf1100c4f0"}
        alt="AES El Salvador"        
        />
        {/* <AESIcon/> */}
        {/* <BrandIcon
        ...
        {/* <BrandIcon
                  ...
                  style={{ width: "38px" }}
                /> */}
         <Box ml={1}>Portal Web AES
        {/* <BrandChip label="AES El Salvador" /> */}
        </Box> 
      </Brand>
      <Scrollbar>
        <List disablePadding>
